    ...
    createBrowserRouter([
        ...
        },
        {
            ...
            children: [
                ...
                {
                    path: 'incentive-scheme-management/:mode/:id?',
                    lazy: async () => {
                        const { IncentiveSchemeManagementManagePage } = await import('./routes/app/incentive-scheme-management-manage');
                        return { Component: IncentiveSchemeManagementManagePage };
                    },
                },
            ],
        },
